OBJS = ast.cmo parser.cmo scanner.cmo generator.cmo probl.cmo
...
#microc.cmx: scanner.cmx parser.cmx interpret.cmx execute.cmx compile.cmx \
    bytecode.cmx ast.cmx 
probl.cmo: scanner.cmo parser.cmi generator.cmo ast.cmo
probl.cmx: scanner.cmx parser.cmx generator.cmx ast.cmx
